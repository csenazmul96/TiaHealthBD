...
class PermissionsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        (28, 0, 'Products Management', 'product-management', 'Getting Product Management Menus'),
            ...
            (142, 0, 'Emergency', 'emergency-management', 'Emergency Module'),
                (143, 142, 'Emergency List', 'emergency-index', 'Can View all Emergency List'),
                (144, 142, 'Emergency create', 'emergency-create', 'Can create Emergency'),
                (145, 142, 'Emergency edit', 'emergency-edit', 'Can Edit Emergency'),
                (146, 142, 'Emergency destroy', 'emergency-destroy', 'Can delete Emergency'),

            (147, 0, 'Test', 'test-management', 'Test Module'),
                (148, 147, 'Test List', 'test-index', 'Can View all Test List'),
                (149, 147, 'Test create', 'test-create', 'Can create Test'),
                (150, 147, 'Test Edit', 'test-edit', 'Can Edit Test'),
                (151, 147, 'Test destroy', 'test-destroy', 'Can delete Test'),
                (152, 147, 'Test Category List', 'test-category-index', 'Can View all Test Category List'),
                (153, 147, 'Test Category creat', 'test-category-create', 'Can create Test Category'),
                (154, 147, 'Test Category edit', 'test-category-edit', 'Can edit Test Categroy'),
                (155, 147, 'Test Category destroy', 'test-category-destroy', 'Can delete Test Categroy'),

         (156, 0, 'Doctor Schedule', 'doctor-schedule-management', 'Doctor Schedule Module'),
                (157, 156, 'New Schedule', 'schedule-index', 'Can View all Schedule List'), 
                (158, 156, 'Schedule create', 'schedule-create', 'Can create Schedule'),
                (159, 156, 'Schedule Edit', 'schedule-edit', 'Can Edit Schedule'),
                (160, 156, 'Schedule destroy', 'schedule-destroy', 'Can delete Schedule'),
                (161, 156, 'Schedule Action', 'schedule-action', 'Can Action Schedule'),
                

         (162, 0, 'Doctor', 'doctor-management', 'Doctor  Module'),
                (163, 162, 'New Doctor', 'doctor-index', 'Can View all Doctor List'), 
                (164, 162, 'Doctor create', 'doctor-create', 'Can create Doctor'),
                (165, 162, 'Doctor Show', 'doctor-show', 'Can Show Doctor'),
                (166, 162, 'Doctor Edit', 'doctor-edit', 'Can Edit Doctor'),
                (167, 162, 'Doctor destroy', 'doctor-destroy', 'Can delete Doctor'),
                (168, 162, 'Doctor Action', 'doctor-action', 'Can action Doctor'),
                

         (169, 0, 'Diagnostic Bill', 'diagnostic-bill-management', 'Diagnostic Bill  Module'),
                (170, 169, 'New Diagnostic Bill', 'diagnostic-bill-index', 'Can View all Diagnostic Bill List'), 
                (171, 169, 'Diagnostic Bill create', 'diagnostic-bill-create', 'Can create Diagnostic Bill'),
                (172, 169, 'Diagnostic Bill Show', 'diagnostic-bill-eidt', 'Can Show Diagnostic Bill'),
                (173, 169, 'Diagnostic Bill Void', 'diagnostic-bill-void', 'Can Edit Diagnostic Bill'),
                (174, 169, 'Diagnostic Bill Action', 'diagnostic-bill-action', 'Can Action Bill'),
                (175, 169, 'Diagnostic Bill Action', 'diagnostic-bill-td', 'Can Action td Bill')
