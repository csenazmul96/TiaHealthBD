                            ...
                            <table class="table table-bordered table-hover Content" id="dataTableNoPagingDesc">
                                <thead>
                                    <tr class="">
                                        ...
                                        @if(Sentinel::hasAccess('schedule-action'))                            
                                ...
                                @foreach($schedules as $row)
                                    <tr>
                                        ...
                                        @if( Sentinel::hasAccess('schedule-edit') || Sentinel::hasAccess('schedule-destroy'))
                                        <td style="display: flex; justify-content: space-evenly;">
                                        @if(Sentinel::hasAccess('schedule-edit'))
                                            <a class="btn waves-effect waves-light text-light btn-xs btn-warning" href="{{ url('schedule/'.$row->id.'/edit') }}"><i class="fa fa-edit"></i></a>
                                            @endif
                                             @if(Sentinel::hasAccess('schedule-destroy'))
