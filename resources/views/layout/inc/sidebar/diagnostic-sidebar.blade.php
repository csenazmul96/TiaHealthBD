        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li class="{{ request()->is('diagnostic/bill/*') ? 'active' : '' }}">
                    <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="{{ Request::is('diagnostic/bill/*')?'true':'false'}}"><i class="mdi mdi-newspaper"></i><span class="hide-menu">Diagnostic Bill</span></a>
