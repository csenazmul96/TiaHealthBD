                            ...
                            <label for="">{{ __('messages.site_logo') }} :</label>
                                <div class="avatar-upload">
                                    ...
                                    <div class="avatar-preview">
                                        <div id="imagePreview" style="background-image: url({{!empty($siteSetting->logo) ? asset($siteSetting->logo) : asset('/uploads/generalSetting/logo/logo.png')}});"></div>
                                    </div>
                        ...
                        <div class="form-group mr-3{{ $errors->has('login_banar') ? ' has-danger' : '' }}">
                            <label for="">{{ __('messages.login_banar') }} :</label>
                                <div class="avatar-upload">
                                    ...
                                    <div class="avatar-preview">
                                        <div id="login_image_Preview" style="background-image: url({{!empty($siteSetting->login_banar) ? asset($siteSetting->login_banar) : asset('/uploads/generalSetting/loginBanar/login-register.jpg')}});"></div>
                                    </div>
                                </div>
                        ...
                        <div class="form-group mr-3{{ $errors->has('reg_banar') ? ' has-danger' : '' }}">
                            <label for="">{{ __('messages.register_banar') }} :</label>
                                <div class="avatar-upload">
                                    ...
                                    <div class="avatar-preview">
                                        <div id="register_image_Preview" style="background-image: url({{!empty($siteSetting->reg_banar)?asset($siteSetting->reg_banar) : asset('/uploads/generalSetting/regBannar')}});"></div>
                                    </div>
                                </div>
