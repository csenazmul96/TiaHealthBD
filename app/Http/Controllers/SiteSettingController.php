...
class SiteSettingController extends Controller
{
    ...
    public function generalUpdate(Request $request, SiteSetting $siteSetting){
        ...
        if ($request->hasFile('logo')) {
            ...
            $logo = Pharma::fileUpload($request,'logo','','/uploads/generalSetting/logo');
        }
        if ($request->hasFile('login_banar')) {
            Storage::delete($request->old_login_banar);
            $login_banar = Pharma::fileUpload($request,'login_banar','','/uploads/generalSetting/loginBanar');
        }
        if ($request->hasFile('reg_banar')) {
            Storage::delete($request->old_reg_banar);
            $reg_banar = Pharma::fileUpload($request,'reg_banar','','/uploads/generalSetting/regBannar');
            // die($reg_banar);
        }
        $data = [
