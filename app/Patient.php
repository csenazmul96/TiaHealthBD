...
{
    protected $fillable = ['patient_name', 'slug', 'email', 'phone','age', 'address','picture','password','gender','description','marital_status','blood_group','guardian','relationship','guardian_phone','gur_addres','occupation','religion','user_id', 'status'];
